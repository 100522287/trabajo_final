// --- BASE DE DATOS DE ARTÍCULOS (Con texto detallado) ---
const dbArticulos = [
    {
        id: 1,
        ...
        htmlContent += `
            <article class="articulo-completo">
                ...
                <div class="contenido-art">
                    <h3>${art.titulo}</h3>
                    <p>${art.descripcion}</p>
                    <button class="btn-leer-mas" onclick="abrirDetalle(${art.id})">Leer más &rarr;</button>
                </div>
            </article>
        `;
    });
...
function abrirDetalle(id) {
    ...
    document.getElementById('detalle-titulo').innerText = articulo.titulo;
    
    // AQUÍ ESTÁ LA CLAVE: Inyectamos el 'texto_completo' con innerHTML para que se vean los <h3> y <br>
    document.getElementById('detalle-cuerpo').innerHTML = articulo.texto_completo;
